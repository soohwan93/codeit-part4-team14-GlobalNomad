  ...
  return (
    <>
      ...
      <div
        id="modal"
        ref={modalRef}
        className={`fixed flex h-screen w-screen flex-col justify-between bg-white p-6 pb-10 shadow-sm md:h-min md:w-[30rem] md:rounded-xl md:pb-8 md:outline md:outline-[#A4a1aa]
                  ${
                    usePortal
